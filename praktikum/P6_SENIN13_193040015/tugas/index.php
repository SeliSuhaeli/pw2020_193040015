...
<body id="home" class="scrollspy">
        ...
        <nav class="background">
            <div class="nav-wrapper">
                ...
                <ul class="right hide-on-med-and-down">
                    ...
                    <li><a href="php/admin.php"><i class="large material-icons" title="admin">account_circle</i></a></li>
                </ul>
            </div>
        </nav>
    </div>
    ...
    <ul class="sidenav" id="mobile-nav">
        ...
        <li>
            <a href="php/admin.php"><i class="small material-icons" title="admin">account_circle</i></a>
        </li>
    </ul>
